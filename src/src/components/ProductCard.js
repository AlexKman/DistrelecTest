          ...
          <div class="col">
            <div class="card-block px-2">
              ...
              <p class="card-text">
                ...
                <br></br>
                <br></br> This board aims to speed up and simplify the
                prototyping of WiFi based IoT applications thanks to the
                flexibility of the ESP32 module and its low power consumption.
              </p>
            </div>
          </div>
        </div>
